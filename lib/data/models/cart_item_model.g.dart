...
int _cartItemEstimateSize(
  ...
  bytesCount += 3 + object.mainImage.length * 3;
...
void _cartItemSerialize(
  ...
  writer.writeString(offsets[1], object.mainImage);
...
CartItem _cartItemDeserialize(
  ...
  object.id = id;
  object.mainImage = reader.readString(offsets[1]);
...
extension CartItemQueryFilter
  ...
  QueryBuilder<CartItem, CartItem, QAfterFilterCondition> mainImageEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CartItem, CartItem, QAfterFilterCondition> mainImageGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<CartItem, CartItem, QAfterFilterCondition> mainImageLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<CartItem, CartItem, QAfterFilterCondition> mainImageBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<CartItem, CartItem, QAfterFilterCondition> mainImageStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CartItem, CartItem, QAfterFilterCondition> mainImageEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CartItem, CartItem, QAfterFilterCondition> mainImageContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<CartItem, CartItem, QAfterFilterCondition> mainImageMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<CartItem, CartItem, QAfterFilterCondition> mainImageIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'mainImage',
        value: '',
...
extension CartItemQuerySortBy on QueryBuilder<CartItem, CartItem, QSortBy> {
  ...
  QueryBuilder<CartItem, CartItem, QAfterSortBy> sortByMainImage() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'mainImage', Sort.asc);
    });
  }

  QueryBuilder<CartItem, CartItem, QAfterSortBy> sortByMainImageDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CartItemQuerySortThenBy
  ...
  QueryBuilder<CartItem, CartItem, QAfterSortBy> thenByMainImage() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'mainImage', Sort.asc);
    });
  }

  QueryBuilder<CartItem, CartItem, QAfterSortBy> thenByMainImageDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'mainImage', Sort.desc);
    });
  }
...
extension CartItemQueryWhereDistinct
  ...
  QueryBuilder<CartItem, CartItem, QDistinct> distinctByMainImage(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension CartItemQueryProperty
  ...
  QueryBuilder<CartItem, String, QQueryOperations> mainImageProperty() {
    return QueryBuilder.apply(this, (query) {
